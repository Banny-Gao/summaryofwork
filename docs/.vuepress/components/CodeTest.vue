<template>
  <div>
    ...
    <div class="select_wraper m-t-10">
      ...
      <a-select
        labelInValue
        :defaultValue="{ key: 'rotateRight' }"
        style="width: 200px;margin-right: 14px;"
        @change="rotateRightSelect"
        v-if="mode === 'rotateRight'"
      >
        <a-select-option value="rotateRight">rotateRight</a-select-option>
        <a-select-option value="rotateRight_timeout"
