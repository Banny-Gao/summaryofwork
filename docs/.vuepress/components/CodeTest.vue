  ...
  <div>
    ...
    <div class="select_wraper m-t-10">
      ...
      <a-select labelInValue
        ...
        <a-select-option value="cloneDeep_Assign">cloneDeep_Assign</a-select-option>
        <a-select-option value="cloneDeep_MessageChannel">cloneDeep_MessageChannel</a-select-option>
